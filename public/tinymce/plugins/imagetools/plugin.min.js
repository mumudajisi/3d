...
!(function () {
    ...
    j = function (h) {
      return new I(function (e, t) {
        !(function () {
          ...
          return p.some(new Blob(u, { type: n }));
        })().fold(function () {
    ...
    return (
      ...
      new I(function (e) {
        ...
        (a.onreadystatechange = function () {
          4 === a.readyState && e({ status: a.status, blob: a.response });
        }),
          a.open("GET", t, !0),
          (a.withCredentials = r),
          (function (e) {
  ...
  function z(e, t) {
    ...
    return F(
      ...
      return H(e.status)
        ? ((t = e.status),
          "application/json" !== (null == (n = e.blob) ? void 0 : n.type) ||
          (400 !== t && 403 !== t && 404 !== t && 500 !== t)
            ? B(t)
            : ((r = n),
              new I(function (e, t) {
      ...
      u.push(i),
        (n[i] = function () {
          ...
          return {
            ...
            log: function (e) {
              console.log(e, { constructors: u, constructor: i, params: n });
            },
          };
        });
    });
  ...
  var V = function (e, t, n) {
    ...
    G = function (e, t, n) {
      ...
      return (
        "v" === n
          ? (o.scale(1, -1), o.drawImage(e, 0, -r.height))
          : (o.scale(-1, 1), o.drawImage(e, -r.width, 0)),
        k(r, t)
      );
    },
    J = [
  ...
  function ue(e, t) {
    if (_e(e, t))
      return q(
        ...
        -1 !==
          f.inArray(
            e.getParam("imagetools_credentials_hosts", [], "string[]"),
            new ye(n.src).host
          ))
      );
    var n, r;
    ...
    return q(
      ...
      e.getParam(
        "api_key",
        e.getParam("imagetools_api_key", "", "string"),
        "string"
      ),
      !1
    );
  ...
  function ce(e, t) {
    ...
    return o
      ...
      : ((n = e),
        (r = t),
        p.from(n.getParam("imagetools_fetch_image", null, "function")).fold(
          function () {
            return ue(n, r);
          },
          function (e) {
            ...
            u.$(d).off("load", r),
              ...
              f
                ...
                : (se(l),
                  (e = u),
                  (t = l),
                  (n = pe.setEditorTimeout(
                    e,
                    function () {
                      e.editorUpload.uploadImagesAuto();
                    },
                    e.getParam("images_upload_timeout", 3e4, "number")
                  )),
                  t.set(n));
          };
          u.$(d).on("load", r),
      ...
      n.each(function (t) {
        re(s, t.dom).each(function (e) {
          ce(s, t.dom).then(function (e) {
            var t = { blob: e, url: URL.createObjectURL(e) };
                            ...
                            (u.w === i.w && u.h === i.h) ||
                              (Y(a) &&
                                ...
                                (n = i) &&
                                  ...
                                  (o = t.style.height),
                                  (r || o) &&
                                    ((t.style.width = n.w + "px"),
                                    (t.style.height = n.h + "px"),
                                    t.removeAttribute("data-mce-style")),
                                  (r = t.width),
                                  (o = t.height),
                                  (r || o) &&
                                    (t.setAttribute("width", String(n.w)),
                                    t.setAttribute("height", String(n.h)))))),
                            URL.revokeObjectURL(e.src),
                            c
                          );
                        })
  ...
  var pe = tinymce.util.Tools.resolve("tinymce.util.Delay"),
    ...
    be = function (e, t) {
      ...
      return (
        0 === n.indexOf("data:") ||
        0 === n.indexOf("blob:") ||
        new ye(n).host === e.documentBaseURI.host
      );
    },
    _e = function (e, t) {
      return (
        -1 !==
        f.inArray(
          e.getParam("imagetools_cors_hosts", [], "string[]"),
          new ye(t.src).host
        )
      );
    };
  o.add("imagetools", function (e) {
    ...
    f.each(
      ...
      ge(e),
      (t = e).ui.registry.addContextToolbar("imagetools", {
        items: t.getParam(
          "imagetools_toolbar",
      ...
      (r = e).on("NodeChange", function (e) {
        ...
        t &&
          ...
          (se(o), r.editorUpload.uploadImagesAuto(), i.set(null)),
          n.each(i.set);
      });
  });
})();
