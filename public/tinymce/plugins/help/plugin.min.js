...
!(function () {
  ...
  function f(e) {
    ...
    return p.mac ? t.join("").replace(/\s/, "") : t.join("+");
  }
  function k(e) {
    function a(e) {
      return (
          ...
          html: [
                  ...
                  function (e) {
                    return (
                      ...
                      (function (e, t, n) {
                        ...
                        function (e) {
                          return a({
                            name: "premium" === e.type ? e.name + "*" : e.name,
                            url:
            ...
            ((t = b(
              m(d, function (e) {
                var t = e.key,
                  n = e.type;
                return "autocorrect" !== t && "premium" === n;
              }),
              function (e) {
                return "<li>" + T.translate(e.name) + "</li>";
              }
            ).join("")),
    ...
    return function () {
      var e,
        ...
        p = (function (e) {
          ...
          b(m.names, function (e) {
            return A((t = h), (n = e)) ? v.from(t[n]) : v.none();
            var t, n;
          })
        );
  ...
  var c = function (n) {
    ...
    T = tinymce.util.Tools.resolve("tinymce.util.I18n"),
    d = b(
      [
        ...
        { key: "rtc", name: "Real-Time Collaboration", type: "premium" },
        {
