        ...
        return (
          ...
          (n = (function (u) {
              ...
              j = {
                ...
                languages: {
                  ...
                  insertBefore: function (t, e, n, a) {
                    ...
                    return (
                      (a[t] = i),
                      j.languages.DFS(j.languages, function (e, n) {
                        n === l && e != t && (this[e] = i);
                      }),
                      i
                    );
                ...
                highlightElement: function (e, n, t) {
                  ...
                  function l(e) {
                    (o.highlightedCode = e),
                      j.hooks.run("before-insert", o),
                      (o.element.innerHTML = o.highlightedCode),
                      j.hooks.run("after-highlight", o),
                      j.hooks.run("complete", o),
                      t && t.call(o.element);
                  }
                  if (
                    (j.hooks.run("before-sanity-check", o),
                    ...
                    return (
                      j.hooks.run("complete", o), void (t && t.call(o.element))
                    );
                  j.hooks.run("before-highlight", o),
                    o.grammar
                      ? n && u.Worker
                        ? (((i = new Worker(j.filename)).onmessage = function (
                            e
                          ) {
                            l(e.data);
                          }),
                        ...
                        : l(j.highlight(o.code, o.grammar, o.language))
                      : l(j.util.encode(o.code));
                },
                highlight: function (e, n, t) {
                  var a = { code: e, grammar: n, language: t };
                  if ((j.hooks.run("before-tokenize", a), !a.grammar))
                    throw new Error(
                      'The language "' + a.language + '" has no grammar.'
                    );
                  return (
                    (a.tokens = j.tokenize(a.code, a.grammar)),
                    j.hooks.run("after-tokenize", a),
                    T.stringify(j.util.encode(a.tokens), a.language)
                  );
                },
                    ...
                    (function e(n, t, a, r, s, i) {
                      for (var o in a)
                        if (a.hasOwnProperty(o) && a[o])
                          for (
                            var l = a[o], l = Array.isArray(l) ? l : [l], u = 0;
                            u < l.length;
                            ++u
                          ) {
                            ...
                            b &&
                              !d.pattern.global &&
                              ((c = d.pattern.toString().match(/[imsuy]*$/)[0]),
                              (d.pattern = RegExp(d.pattern.source, c + "g")));
                            for (
                              var f = d.pattern || d, h = r.next, y = s;
                              ...
                              if (!(w instanceof T)) {
                                ...
                                if (b) {
                                  ...
                                  if (
                                    ((y = F -= h.value.length),
                                    h.value instanceof T)
                                  )
                                    continue;
                                  for (
                                    var S = h;
                                    S !== t.tail &&
                                    (F < _ || "string" == typeof S.value);
                                    S = S.next
                                  )
                                    v++, (F += S.value.length);
                                ...
                                var C,
                                  h = O(
                                    t,
                                    E,
                                    new T(o, p ? j.tokenize(A, p) : A, m, A)
                                  );
                                $ && O(t, h, $),
                                  1 < v &&
                                    (e(
            ...
            function B(e, n, t, a) {
              ...
              return (
                s &&
                  a &&
                  s[1] &&
                  ((r = s[1].length), (s.index += r), (s[0] = s[0].slice(r))),
                s
              );
            }
            function s() {
                    ...
                    u.addEventListener(
                      ...
                      function (e) {
                        var n = JSON.parse(e.data),
                          ...
                          a = n.code,
                          r = n.immediateClose;
                        u.postMessage(j.highlight(a, j.languages[t], t)),
                          r && u.close();
                      },
                      !1
                    )),
            ...
            return (
              r &&
                ((j.filename = r.src),
                r.hasAttribute("data-manual") && (j.manual = !0)),
              j.manual ||
                ("loading" === (a = document.readyState) ||
                ("interactive" === a && r && r.defer)
          ...
          Object.defineProperties((h.languages["markup-templating"] = {}), {
            ...
            tokenizePlaceholders: {
              value: function (g, b) {
                ...
                g.language === b &&
                  g.tokenStack &&
                  ((g.grammar = h.languages[b]),
                  (m = 0),
                  (f = Object.keys(g.tokenStack)),
                  (function e(n) {
          ...
          (function (t) {
            ...
            (t.languages.csharp = t.languages.extend("clike", {
              ...
              "class-name": [
                ...
                { pattern: r(/(\bwhere\s+)<<0>>/.source, [m]), lookbehind: !0 },
                {
                ...
                "type-list": {
                  pattern: r(
                    /\b((?:<<0>>\s+<<1>>|record\s+<<1>>\s*<<5>>|where\s+<<2>>)\s*:\s*)(?:<<3>>|<<4>>|<<1>>\s*<<5>>|<<6>>)(?:\s*,\s*(?:<<3>>|<<4>>|<<6>>))*(?=\s*(?:where|[{;]|=>|$))/
                      .source,
                    [u, f, m, x, c.source, b, /\bnew\s*\(\s*\)/.source]
                  ),
                  lookbehind: !0,
                  inside: {
                    "record-arguments": {
          ...
          (o = /(?:[a-z]\w*\s*\.\s*)*(?:[A-Z]\w*\s*\.\s*)*/.source),
          (l = {
            pattern: RegExp(
              /(^|[^\w.])/.source + o + /[A-Z](?:[\d_A-Z]*[a-z]\w*)?\b/.source
            ),
            lookbehind: !0,
            inside: {
              namespace: {
          ...
          s.languages.insertBefore("java", "class-name", {
            ...
            import: [
              {
                pattern: RegExp(
                  /(\bimport\s+)/.source + o + /(?:[A-Z]\w*|\*)(?=\s*;)/.source
                ),
                lookbehind: !0,
                inside: {
