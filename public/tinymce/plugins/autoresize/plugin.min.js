...
!(function () {
  ...
  var l = Object.hasOwnProperty,
    ...
    b = tinymce.util.Tools.resolve("tinymce.Env"),
      ...
      h &&
        (e.plugins.fullscreen && e.plugins.fullscreen.isFullscreen()
          ...
          : ((i = h.documentElement),
            ...
            (r = y(e)),
            (s = v(d, i, "margin-top", !0)),
            (a = v(d, i, "margin-bottom", !0)),
            (l = (l = i.offsetHeight + s + a + o) < 0 ? 0 : l) +
              (u =
                e.getContainer().offsetHeight -
                e.getContentAreaContainer().offsetHeight) >
              y(e) && (r = l + u),
            (g = e.getParam("max_height", 0, "number")) && g < r
              ? ((r = g), p(e, !0))
              : p(e, !1),
            r !== t.get() &&
              ((c = r - t.get()),
              d.setStyle(e.getContainer(), "height", r + "px"),
              t.set(r),
              e.fire("ResizeEditor"),
              b.browser.isSafari() &&
                b.mac &&
              ...
              !e.hasFocus() ||
                "setcontent" !==
                  (null == (f = n) ? void 0 : f.type.toLowerCase()) ||
                (!0 !== f.selection && !0 !== f.paste) ||
                e.selection.scrollIntoView(),
              b.webkit && c < 0 && C(e, t, n))));
    };
  e.add("autoresize", function (e) {
    var t,
      ...
      s,
      a = e.settings;
    l.call(a, "resize") || (e.settings.resize = !1),
      e.inline ||
        ((s = 0),
        (r = t =
          {
