...
!(function () {
  ...
  function Y(e, n, r, t) {
    return { x: e, y: n, width: r, height: t, right: e + r, bottom: n + t };
  }
  function G(r, t, e) {
    return K(e)
      .map(function (e) {
  ...
  function J(e, n) {
    e.fire("FullscreenStateChanged", { state: n }), e.fire("ResizeEditor");
  }
  function Q(e) {
  ...
  function Z(e) {
    return (
      e.dom ===
      (void 0 !== (n = I(e).dom).fullscreenElement
        ? n.fullscreenElement
        : void 0 !== n.msFullscreenElement
    ...
    var t,
      ...
      l =
        ...
        b(
          (function (e, n) {
            for (
              var r = h(n) ? n : v, t = e.dom, o = [];
              null !== t.parentNode && void 0 !== t.parentNode;
      ...
      m =
        ...
        void 0 !==
          (a =
            "" !== (c = window.getComputedStyle(u).getPropertyValue(i)) || Pe(t)
              ? c
              : Me(u, i)) && "" !== a
          ? "background-color:" + a + "!important"
          : "background-color:rgb(255,255,255)!important;");
    D(f, r("display:none!important;")),
      D(l, r(Xe + _e + m)),
      r((!0 === ze ? "" : Xe) + _e + m)(e);
  }
  function re(r, t) {
  ...
  var ue,
    ...
    pe = "Firefox",
    we = function () {
      return oe({ current: void 0, version: he.unknown() });
    },
    ye = oe,
    be =
      (y("Edge"),
    ...
    Oe = "ChromeOS",
    Fe = function () {
      return ie({ current: void 0, version: he.unknown() });
    },
    Te = ie,
    ke =
      (y(be),
      ...
      (ae = !(ue = function () {
        return (
          ...
          (n = A.from(navigator.userAgentData)),
          (r = W),
          (v = ge.browsers()),
          (g = ge.oses()),
          (p = n
            ...
            .fold(Fe, Te)),
          {
            ...
            deviceType:
              ...
              (u = e),
              (c = r),
              (a = (o = w).isiOS() && !0 === /ipad/i.test(u)),
              (s = o.isiOS() && !a),
              (f = (l = o.isiOS() || o.isAndroid()) || c("(pointer:coarse)")),
              (m = a || (!s && l && c("(min-device-width:768px)"))),
              (d = s || (l && !m)),
              (h = i.isSafari() && o.isiOS() && !1 === /safari/i.test(u)),
              {
                isiPad: y(a),
                isiPhone: y(s),
                isTablet: y(m),
    ...
    Ke = function (o, i) {
      ...
      function e() {
        ...
        F &&
          ...
          (e = "[" + Ve + "]"),
          D(
            (1 !== (n = t = document).nodeType &&
              9 !== n.nodeType &&
              11 !== n.nodeType) ||
              0 === n.childElementCount
              ? []
              : C(t.querySelectorAll(e), L.fromDom),
            function (e) {
              var n = X(e, Ve);
              "no-styles" !== n ? z(e, r.parseStyle(n)) : _(e, "style"),
                _(e, Ve);
            }
          )),
          u(Ue.removeClass),
          $e.unbind(),
          A.from(i.get()).each(function (e) {
      ...
      E
        ? (E.fullscreenChangeHandler.unbind(),
          Q(o) &&
            Z(x) &&
            ((c = I(x).dom).exitFullscreen
              ? c.exitFullscreen()
              : c.msExitFullscreen
              ? c.msExitFullscreen()
              : c.webkitCancelFullScreen && c.webkitCancelFullScreen()),
          (k.width = E.iframeWidth),
          (k.height = E.iframeHeight),
          (T.width = E.containerWidth),
          (T.height = E.containerHeight),
          (T.top = E.containerTop),
          (T.left = E.containerLeft),
          e(),
          (t = E.scrollPos),
        ...
        : ((n = $(
          ...
          (r = {
            scrollPos:
              ...
              (g = v.document),
              (d =
                (m = void 0 !== (f = L.fromDom(g)) ? f.dom : document).body
              ...
              K(v).fold(
                ...
                function (e) {
                  return Y(
                    Math.max(e.pageLeft, p.left),
                    Math.max(e.pageTop, p.top),
                    e.width,
                    e.height
                  );
                }
  ...
  t.add("fullscreen", function (e) {
    ...
    return (
      e.inline ||
        ((r = u),
        (n = e).addCommand("mceFullScreen", function () {
          Ke(n, r);
        }),
