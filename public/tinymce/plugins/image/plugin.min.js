...
!(function () {
  ...
  function q(e) {
    return (
      0 === Ue.getAttrib(e, "alt").length &&
      "presentation" === Ue.getAttrib(e, "role")
    );
  }
  function Q() {
    return {
  ...
  function ae(r, e) {
    var t = (function (e) {
      ...
      if (
        ...
        Ie(t, e.alt, e.isDecorative),
        e.caption)
      ) {
        var n = Ue.create("figure", { class: "image" });
        return (
          n.appendChild(t),
          n.appendChild(
            Ue.create("figcaption", { contentEditable: "true" }, "Caption")
          ),
    ...
    r.dom.setAttrib(i, "data-mce-id", null),
      Z(i) ? ((n = ie(r, i)), r.selection.select(n)) : r.selection.select(i);
  }
  function oe(t, e) {
    var n,
      r,
    ...
    function y() {
      (f.onload = f.onerror = null),
        g.selection && (g.selection.select(f), g.nodeChanged());
    }
    b
      ? ((n = Y(function (e) {
          return ne(t, e);
        ...
        r.src
          ? ((m = i),
            ...
            u.dom.setAttrib(h, "src", h.getAttribute("src")),
            Z(h.parentNode)
              ? ((d = h.parentNode), ie(u, d), u.selection.select(h.parentNode))
              : (u.selection.select(h),
                (g = u),
                (p = m),
                ((f = h).onload = function () {
                  p.width ||
          ...
          : ((a = t),
            (o = b) &&
              ((l = a.dom.is(o.parentNode, "figure.image") ? o.parentNode : o),
              a.dom.remove(l),
              a.focus(),
              a.nodeChanged(),
  ...
  function de(e, t, n, r) {
    ...
    (U = t),
      ...
      (/^(?:[a-zA-Z]+:)?\/\//.test(O)
        ...
        I.setData({ src: { value: e, meta: C.src.meta } });
      }),
      (h = t),
      (w = (b = r).getData()),
      void 0 !== (S = w.src.meta) &&
        ...
        T(D.class) &&
          Ee(v.classList, D.class).each(function (e) {
            A.classes = e.value;
          }),
    ...
    return function (e, t) {
      ...
      "src" === t.name
        ...
        ? ((c = S),
          ...
          (m = I),
          (g = (d = e).getData()),
          (p = Ee(u.imageList, g.images)).each(function (e) {
            "" === g.alt ||
            m.prevImage
              .map(function (e) {
                return e.text === g.alt;
        ...
        : "vspace" === t.name ||
          ...
          "borderstyle" === t.name
        ? ((n = S),
          (i = xe(ue(U.image), (r = e).getData())),
          (f = n.normalizeCss),
          (h = me(i, !1)),
          F((b = document.createElement("img")), "style", h.style),
          (!k(b) && "" === h.hspace) || $(b, h.hspace),
          (!z(b) && "" === h.vspace) || J(b, h.vspace),
          (!M(b) && "" === h.border) || K(b, h.border),
          (!B(b, "borderStyle") && "" === h.borderStyle) || X(b, h.borderStyle),
          (a = f(b.getAttribute("style"))),
          r.setData({ style: a }))
        : "fileinput" === t.name
        ? ge(S, U, I, e)
        : "isDecorative" === t.name &&
    ...
    var t,
      ...
      A = {
        onSubmit: function (n) {
          return function (e) {
            ...
            c.execCommand(
              "mceUpdateImage",
              !1,
              me(t, n.hasAccessibilityOptions)
            ),
        ...
        imageSize: function (e) {
          return R(s, e)
            ? ((i = s.documentBaseURI.toAbsolute(e)),
              new De(function (t) {
                function n(e) {
        ...
        uploadImage:
          ...
          function (e) {
            return Oe(t)
              ...
              .then(function (e) {
                return 0 === e.length
                  ? De.reject("Failed to upload image")
                  : !1 === e[0].status
                  ? De.reject(e[0].error.message)
                  : e[0];
              });
          }),
      };
    return {
      open: function () {
        ...
        (r = v),
          ...
          (o = _e(r.getParam("image_class_list"))),
  ...
  function he(a) {
    return function (e) {
      for (
        ...
        (r = i.attr("class")) &&
          /\bimage\b/.test(r) &&
          (i.attr("contenteditable", a ? "false" : null),
          Te.each(i.getAll("figcaption"), n));
      }
    };
  }
  ...
  var ye,
    ...
    Ie = function (e, t, n) {
      n
        ? (Ue.setAttrib(e, "role", "presentation"), I(ve(e), "alt", ""))
        : (i === t ? ve(e).dom.removeAttribute("alt") : I(ve(e), "alt", t),
          "presentation" === Ue.getAttrib(e, "role") &&
            Ue.setAttrib(e, "role", ""));
    },
    Ce = function (e, t, n) {
      ...
      ee(n, r, t, "caption", function (e, t, n) {
        return (
          H((r = e))
            ? ((o = r.parentNode), Ue.insertAfter(r, o), Ue.remove(o))
            : ((i = r),
              (a = Ue.create("figure", { class: "image" })),
              Ue.insertAfter(a, i),
              a.appendChild(i),
              a.appendChild(
                Ue.create("figcaption", { contentEditable: "true" }, "Caption")
        ...
        ee(n, r, t, "src", F),
        ee(n, r, t, "title", F),
        ee(n, r, t, "width", W(0, e)),
        ee(n, r, t, "height", W(0, e)),
        ee(n, r, t, "class", F),
        ee(
          n,
          r,
        ...
        ee(n, r, t, "hspace", te($, e)),
        ee(n, r, t, "vspace", te(J, e)),
        ee(n, r, t, "border", te(K, e)),
        ee(n, r, t, "borderStyle", te(X, e)),
        (t.alt === r.alt && t.isDecorative === r.isDecorative) ||
          Ie(n, t.alt, t.isDecorative);
    },
    xe =
      ((ye = function (e, t) {
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var i,
            a = e[r];
          for (i in a) h(a, i) && (n[i] = ye(n[i], a[i]));
        }
        return n;
      }),
    ...
    Ne = function (e, a) {
      ...
      return (
        Te.each(e, function (e) {
          ...
          void 0 !== e.menu
            ? ((n = Ne(e.menu, a)), o.push({ text: i, items: n }))
            : ((r = a(e)), o.push({ text: i, value: r }));
        }),
        o
      );
    },
    ...
    ke = function (e) {
      return { title: "General", name: "general", items: ce(e) };
    },
    ze = ce,
    Me = function (e) {
      return {
  ...
  o.add("image", function (e) {
    ...
    (t = e).on("PreInit", function () {
      t.parser.addNodeFilter("figure", he(!0)),
        t.serializer.addNodeFilter("figure", he(!1));
    }),
      (n = e).ui.registry.addToggleButton("image", {
        ...
        onSetup: function (e) {
          return (
            e.setActive(D(re(n))),
            n.selection.selectorChangedWithUnbind(
      ...
      (r = e).addCommand("mceImage", fe(r).open),
      r.addCommand("mceUpdateImage", function (e, t) {
