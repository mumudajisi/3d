<template>
    <div class="right-menu">
        <el-popover
            ...
            trigger="click"
            popper-class="table-menu-popver"
        >
            <div class="right-menu-containter">
                <div class="right-menu-header">
                    <el-checkbox :value="isAllChecked" @change="toggleAll">
                        <span class="text">列展示</span>
                    </el-checkbox>
                    <el-link type="primary" :underline="false" @click="setDefaultValue">
                        重置
                    </el-link>
                </div>
            ...
            <template #reference>
                <el-tooltip class="item" effect="dark" content="列设置" placement="top">
                    <el-button type="text" class="el-icon-s-tools setting" />
                </el-tooltip>
            </template>
        </el-popover>
    </div>
